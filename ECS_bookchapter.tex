...
Extracellular potentials measured within neural tissue often contains contributions from both synaptic input to large populations of neurons, and from action potentials of neurons in the immediate vicinity of the recording electrode (Fig.~\ref{fig:LFP_MUA}A-C). 
Since these two contributions have different biophysical origins, they can give different insights into the ongoing neural activity, and they can be separated by splitting the extracellular potential into two separate frequency parts. The low frequency part, that is, the LFP, reflects synaptic input to populations of pyramidal cells (Fig.~\ref{fig:LFP_MUA}D), while the high-frequency part, that is, the multi-unit activity (MUA), reflects the population spiking activity (Fig.~\ref{fig:LFP_MUA}E-F).
