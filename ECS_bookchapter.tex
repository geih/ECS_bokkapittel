...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.6\textwidth]{dipoles}% This is a *.eps file
%\includegraphics[width=\textwidth]{\string~/Dropbox/ConvNet_LFP_figures/parameter_errors_full}% This is a *.eps file
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=1\textwidth]{population_EEG_MEG.png}% This is a *.eps file
%\includegraphics[width=\textwidth]{\string~/Dropbox/ConvNet_LFP_figures/parameter_errors_full}% This is a *.eps file
\end{center}
...
However, highly synchronized spikes are expected to be very important for hippocampal sharp wave ripples \cite{Schomburg2012, Luo2018}. 
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=1\textwidth]{head_models.png}% This is a *.eps file
%\includegraphics[width=\textwidth]{\string~/Dropbox/ConvNet_LFP_figures/parameter_errors_full}% This is a *.eps file
\end{center}
