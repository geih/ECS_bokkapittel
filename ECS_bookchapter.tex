...
not affected by extracellular potentials, and to simulate the neurodynamics as a first independent step, before computing the extracellular potentials in the next step. \ghnote{Tok vekk Gautes forslag, som dro inn volumer og konsentrasjoner. Setningen begynte med "Since the extracellular potentials", saa dette handlet kun om dem, egentlig. Gaute, kan du godkjenne siste setning?}
