...
\end{equation}
Here, $\mathbf{p}$ is the current dipole moment and $\theta$ is the angle between the current dipole moment and the distance vector $\mathbf{R}$. The current dipole moment can be found by summing up all the \tvntxt{position-weighted} transmembrane currents from a neuron \citep{Pettersen2008, Pettersen2014, Nunez2006}: 
