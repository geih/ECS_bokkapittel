...
In this section we start with the fairly general assumption that ions move through the brain due to the combined influence of electric fields and diffusion. Building on this, we then first describe several computational schemes for modelling electrodiffusive processes before we derive the fundamental equations for VC theory assuming negligible effects from diffusion.
